#!/bin/bash
#SBATCH --job-name=eval_sync_bar
#SBATCH --output=logs/eval_sync_bar_%j.out
#SBATCH --error=logs/eval_sync_bar_%j.err
...
RUN_DIR="runs/slim_octuple_mask_ddpm_trio_octuple_sync_bar"
