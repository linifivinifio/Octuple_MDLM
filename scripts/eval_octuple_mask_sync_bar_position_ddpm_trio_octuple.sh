#!/bin/bash
#SBATCH --job-name=eval_sync_bar_position
#SBATCH --output=logs/eval_sync_bar_position_%j.out
#SBATCH --error=logs/eval_sync_bar_position_%j.err
...
echo "Strategy: sync_bar_position"
echo "========================================"
